...
@EnableJpaRepositories( basePackages={ "com.eli.cruises.persistence.repository" })
 class PersistenceConfig {
	...
	@Bean
	 LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManagerFactory.setPackagesToScan( new String[] { "com.eli.cruises.persistence.entities" });
